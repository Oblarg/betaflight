...
typedef struct {
    ...
    float KiVoltPerRotation[${resolution}][${resolution}][${resolution}][${resolution}][4][3];
    // Rate gains: volts per rotation per second
    float KpVoltPerRotationPerSecond[${resolution}][${resolution}][${resolution}][${resolution}][4][3];
    float BDiscreteInvVoltSecondPerRotation[${resolution}][${resolution}][${resolution}][${resolution}][4][3];
} ModelLookup;
